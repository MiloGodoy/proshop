...
import Order from '../config/models/orderModel.js';
...
const updateOrderToPaid = asyncHandler(async (req, res) => {
    ...
    console.log('Verification result:', { verified, value });
  
    // check if this transaction has been used before
    console.log('Checking if new transaction...');
    ...
    console.log('Order found:', order ? order._id : 'none');
